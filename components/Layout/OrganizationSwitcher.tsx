  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      <button
        ...
        className="px-4 py-2 rounded-lg border bg-white dark:bg-zinc-900 border-zinc-300 dark:border-zinc-700 text-sm font-medium hover:bg-zinc-100 dark:hover:bg-zinc-800 transition"
      >
